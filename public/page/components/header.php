...
<div id="header">
	...
	<div class="dropdown">
		...
		<div id="friend_btn" onclick="Navigate(`/my-friend`)">
			...
			<span id="number_invite" class="notify">3</span>
		</div>
		<!-- end friend button -->

		<!-- start-dropdown-btn -->
		<div id="dropdown_btn" onclick="handleDropdown()">
			<img src="<?= $authInfor->avatar ? base64_decode($authInfor->avatar) : "../../asset/logo.webp" ?>" alt="user's avatar" id="avt" width="50px" height="50px">
