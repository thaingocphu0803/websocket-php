...
<div id="inbox" class="hidden">
	<div class="inbox-header">
		<img id="avt" src="../asset/logo.jpeg" alt="user's avatar" width="50px" height="50px">
	...
	<div class="inbox-button">
		...
		<input id="inbox_image" name="inbox_image" class="input-file" type="file" accept="image/*" multiple>
