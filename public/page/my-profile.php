		...
		<div class="avt-profile">
			...
			<div class="edit-fullname-group">
				...
				<div class="fullname-btn-group">
					<!-- open edit full name -->
					<button id="update_fullname_btn"  class="edit-fullname-btn" title="Click to change your name">
					...
					<!-- save edit full name -->
					<button  class="edit-fullname-btn" id="save_fullname">Save</button>
					<!-- cancel edit full name -->
					<button class="edit-fullname-btn" id="cancel_fullname">Cancel</button>
				</div>
			</div>
