<div id="form_container">
	...
	<form id="form_login" onkeyup="submitLogin(event)">
		...
		<div class="from-authen-input">
			...
			<input id="username" class="input-form" name="username" type="text" placeholder="Enter your username">
		</div>
		...
		<div class="from-authen-input">
			...
			<input id="password" class="input-form" name="password" type="password" placeholder="Enter your password">
		</div>
